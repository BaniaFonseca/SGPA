...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('B'.$i++, "Onde, n: a quantidade do tipo de Avaliações")
        ->setCellValue('B'.$i++, "a) O estudante nao realizou avaliaçao");
$i=$i+1;
...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('H'.$i++, "Director Adj. Pedagogico")
        ->setCellValue('H'.$i++, "____________________")
        ->setCellValue('H'.$i++, get_nome_adj());
...
$senha = rand(10, 1000);
$objPHPExcel->getActiveSheet()->getProtection()->setPassword('esimop-ac'.$senha);
