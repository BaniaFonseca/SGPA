          ...
          if ($_GET['ctr'] == 1){
	       ...
	       $pdf=new FPDF();
              ...
              $pdf->SetX(20);
                    ...
                    $pdf->Cell($largura2, $altura, utf8_decode($s), 1, 0, 'C');
                    ...
                    $est_add_ex = $ctr_est->contar_media($_SESSION['curso'], $_SESSION['disp'],3);
                    ...
                    $pdf->ln();
                    $pdf->SetX(82);
                    $pdf->Cell(50, 5, utf8_decode($myvar->buscar_docente($_SESSION['disp'])), 0, 0, 'C');
